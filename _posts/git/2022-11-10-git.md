...
⇒ [Glossary git](../glossary-git)<br>
⇒ [git best pratice](../git-best-pratice)<br>
⇒ [How to write a commit message](../git-commit-message)<br>
⇒ [git commit --amend](../git---amend)<br>
⇒ [uncommit](../uncommit)
...
For more information on how to write a commit message, check out [How to Write a Git Commit Message](../git-commit-message)

#### Append changes to the last commit 

To append/ modify changes to the last commit, check out [git commit --amend](../git---amend)
...
To undo a commit, check out [Uncommit](../uncommit)
